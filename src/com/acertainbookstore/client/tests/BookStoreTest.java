...
public class BookStoreTest {
    ...
    public void testRateBook() throws BookStoreException {
        ...
        bookRatings.add(new BookRating(TEST_ISBN, 5));
        client.rateBooks(bookRatings);
        List<StockBook> books = storeManager.getBooksByISBN(new HashSet<>(Collections.singletonList(TEST_ISBN)));
        assertEquals(5, books.get(0).getTotalRating());
        assertEquals(1, books.get(0).getNumTimesRated());
    }
    ...
    public void testRateBookNullException() throws BookStoreException {
    ...
    public void testRateInvalidISBN() throws BookStoreException {
        ...
        bookRatingSet.add(new BookRating(0, 5));
        client.rateBooks(bookRatingSet);
    }

    /**
     * test an invalid rating
     *
     * @throws BookStoreException the book store exception
     */
    @Test(expected = BookStoreException.class)
     ...
     */
    @Test(expected = BookStoreException.class)
    public void testTopRatedBooksInvalidNum() throws BookStoreException {
    ...
    public void testTopRatedBooks() throws BookStoreException {
        addBooks(1, 1);
        Set<BookRating> bookRatingSet = new HashSet<>(Arrays.asList(new BookRating(TEST_ISBN, 5), new BookRating(1, 4)));
        client.rateBooks(bookRatingSet);
        assertEquals(2, client.getTopRatedBooks(2).size());
        assertEquals(TEST_ISBN, client.getTopRatedBooks(2).get(0).getISBN());
        assertEquals("Test of Thrones", client.getTopRatedBooks(2).get(1).getTitle());
    }
